...
<html lang="en">
    <head>
        <meta charset="en">
            ...
            <title>EcommerceWebsite-Cartpage</title>
            <!-- CSS only -->
...
?>
    <tr>
        ...
        <td><img src="./admin_area/product_images/<?php echo $product_image2 ?> 
...
?>
        ...
        name="removeitem[]"value="<?php echo 
        $product_id ?>"></td>
        <td>
           
          <!-- <button class="bg-dark text-light px-3 py-2
             border-0 mx-3">Update</button>-->
            <input type="submit"value="Update cart"class="bg-dark text-light px-3 py-2
             border-0 mx-3 "name="update_cart">
             <input type="submit"value="Remove cart"class="bg-dark text-light px-3 py-2
...
<h4 class='px-3'>Subtotal:<strong class='text-info'>
 ...
 <input type='submit' value='Continue Shopping' class='bg-dark text-light px-3 py-2 border-0 mx-3'
  name='continue_shopping'>
  <input type='submit' value='checkout' class='bg-dark text-light px-3 py-2 border-0 mx-3'
  name='checkout'>

 <!--
  echo" <a href= 'index.php '><button class='bg-dark text-light px-3 py-2 border-0 mx-3'>Continue Shopping</button></a>";
}-->
<?php
